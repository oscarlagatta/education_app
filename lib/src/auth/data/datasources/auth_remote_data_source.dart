...
import 'package:education_app/core/resources/media_res.dart';
...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<void> forgotPassword(String email) async {
    try {
      // will send email to the user, will receive a link
  ...
  Future<LocalUserModel> signIn({
    ...
    try {
      ...
      // we assume that the user already has its data in Firestore.
      ...
      // id document doesn't exist upload the user
  ...
  Future<void> signUp({
    ...
    try {
      ...
      await userCred.user?.updatePhotoURL(MediaRes.user); // kDefaultAvatar
